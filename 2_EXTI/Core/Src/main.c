...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : BUTTON_B_Pin BUTTON_C_Pin BUTTON_D_Pin */
  GPIO_InitStruct.Pin = BUTTON_B_Pin|BUTTON_C_Pin|BUTTON_D_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
